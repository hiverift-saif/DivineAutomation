          ...
          <Tabs defaultValue="robotics" className="max-w-6xl mx-auto">
            ...
            <TabsContent value="robotics">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="relative h-[600px] rounded-lg overflow-hidden shadow-xl">
                  <ImageWithFallback
                    src="https://images.unsplash.com/photo-1727373203627-73457889fe0f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxpbmR1c3RyaWFsJTIwcm9ib3RpY3MlMjB3ZWxkaW5nfGVufDF8fHx8MTc2Mjg1Nzg2MXww&ixlib=rb-4.1.0&q=80&w=1080"
                    alt="Robotic Welding"
            ...
            <TabsContent value="hydraulic">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="relative h-[600px] rounded-lg overflow-hidden shadow-xl">
                  <ImageWithFallback
                    src="https://images.unsplash.com/photo-1716191300020-b52dec5b70a8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjbmMlMjBtYWNoaW5lJTIwZmFjdG9yeXxlbnwxfHx8fDE3NjI4NTc4NjF8MA&ixlib=rb-4.1.0&q=80&w=1080"
            ...
            <TabsContent value="assembly">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="relative h-[600px] rounded-lg overflow-hidden shadow-xl">
                  <ImageWithFallback
                    src="https://images.unsplash.com/photo-1716191299980-a6e8827ba10b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxyb2JvdGljJTIwYXNzZW1ibHklMjBsaW5lfGVufDF8fHx8MTc2Mjg1Nzg2MHww&ixlib=rb-4.1.0&q=80&w=1080"
                    alt="Assembly Line"
                    className="w-full h-full object-cover"
                  />
                </div>
